...
def main():
    baseurl = "https://www.bilibili.com/bangumi/media/md28229881/?spm_id_from=666.25.b_6d656469615f6d6f64756c65.2#short"
    #1.爬取网页
...
findname = re.compile(r'<span class="media-info-title-t">(.*?)</span>')
...
def getData(baseurl):
    ...
    # for item in soup.find_all('div',class_="media-info-r"):        #查找符合要求的字符串，形成列表
    ...
    #     data.append(type)
    #     print(type)
    # print(soup.find_all('div'))        #查找符合要求的字符串，形成列表
        # print(item)    #测试查看电影item全部信息
        # data = []      #保存一部电影的所有信息<span class="media-info-title-t">
        # item = str(item)
